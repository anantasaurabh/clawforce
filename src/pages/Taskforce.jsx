 ...
 return (
  <div className="max-w-7xl mx-auto space-y-10">
   <header className="space-y-4">
    <h1 className="text-5xl font-black text-slate-900 ">Taskforce</h1>
    <p className="text-slate-400 text-lg max-w-3xl font-medium leading-relaxed">
     Access elite autonomous agents, manage task configurations, and scale your operational capacity.
    </p>
   </header>
      ...
      >
       ...
       <div className="p-8 pt-12 flex flex-col items-center text-center flex-1 relative">
        ...
        <div className="space-y-1 mb-4">
         ...
         <h3 className="text-2xl font-black text-slate-900 group-hover:text-brand-primary transition-colors">{agent.name}</h3>
        </div>
        ...
        <div className="w-full grid grid-cols-3 gap-2">
         ...
         <div className="text-center border-x border-slate-50">
          ...
          <p className="text-lg font-black text-slate-900 ">{stats.completed}</p>
         </div>
         <div className="text-center">
          <p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Attention</p>
          <p className={cn("text-lg font-black ", stats.attention > 0 ? "text-red-500" : "text-slate-900")}>
           {stats.attention}
          </p>
         </div>
        </div>
